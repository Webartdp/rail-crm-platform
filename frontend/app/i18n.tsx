...
const dictionaries: Record<Locale, Dictionary> = {
  ru: {
    ...
    backendUnavailable: 'Не могу получить состояние сотрудника. Проверь backend на http://localhost:8000.',
  ...
  de: {
    ...
    backendUnavailable: 'Mitarbeiterstatus kann nicht geladen werden. Prüfe backend auf http://localhost:8000.',
